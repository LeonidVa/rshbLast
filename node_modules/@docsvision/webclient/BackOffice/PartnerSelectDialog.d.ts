...
import("styled-components").StyledComponent<typeof SimpleItemViewContent, any, ICustomTreeNodeContentDefaultProps, never>;
    ...
    readonly selectedPartner: GenModels.DepartmentModel | GenModels.EmployeeDataModel;
    ...
    private readonly employeeMode;
    private readonly departmentMode;
    private readonly organizationMode;
    ...
    protected stopPropagation: (ev: React.MouseEvent<Element>) => void;
