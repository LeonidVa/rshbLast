...
export declare class LinksImpl extends PanelImpl<LinksParams, LinksState> {
    ...
    protected onShowColumnSettingsDialog: (event: React.MouseEvent<any>) => Promise<void>;
    ...
    selectAll(): JQueryDeferred<{}>;
    clearSelection(): JQueryDeferred<{}>;
    setSelection(selection: LinkSelectionItem[]): JQueryDeferred<{}>;
