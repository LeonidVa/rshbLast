...
export declare class PartnerTypeaheadVariant implements ITypeaheadVariant {
    ...
    constructor(item: GenModels.PartnerDirectoryItem, visualiser: PartnerDirectoryItemVisualiser, editAllowed: boolean, reload: (newValue: GenModels.DepartmentModel | GenModels.EmployeeDataModel) => void, departmentMode: boolean, services: $LayoutRowController & $LocationContainerControlServices & $LayoutStaffController & $DepartmentController);
    readonly name: string;
    readonly value: string;
    readonly iconCssClass: string;
    readonly title: string;
    protected onCreateOrganization: (ev: React.MouseEvent<Element>) => Promise<void>;
    protected onCreateDepartment: (ev: React.MouseEvent<Element>) => Promise<void>;
    protected onCreateEmployee: (ev: React.MouseEvent<Element>) => Promise<void>;
    private onInfoClick;
    private onInfoClose;
    private stopPropagation;
    readonly rightButtons: JSX.Element[];
}
