...
import { $IsIE10 } from '@docsvision/webclient/StandardServices';
...
export declare class TasksTreeParams extends BaseControlParams {
    ...
    options: 
import("vis").Options;
    services?: $FileController & $LayoutFileController & $RequestManager & $CardInfo & $EditOperationStore & $Layout & $IsIE10 & $CardId;
}
/**
