...
export declare const $Router: FieldSpec<$Router, IRouter & ILegacyRouter & IRouterNavigation>;
export declare type $RouterNavigation = {
    routerNavigation: IRouterNavigation;
};
export declare const $RouterNavigation: FieldSpec<$RouterNavigation, IRouterNavigation>;
