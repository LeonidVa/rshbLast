...
export declare const $LayoutInfo: FieldSpec<$LayoutInfo, GenModels.LayoutInfoModel>;
/** Сервис информации о карточке. */
export declare type $CardInfo = {
    cardInfo: GenModels.CardInfoModel;
};
export declare const $CardInfo: FieldSpec<$CardInfo, GenModels.CardInfoModel>;
/** Сервис информации о карточке. */
export declare type $RowInfo = {
    rowInfo: GenModels.RowInfoModel;
};
export declare const $RowInfo: FieldSpec<$RowInfo, GenModels.RowInfoModel>;
