...
export declare type $LocationContainerControlServices = Optional<$LayoutController> & $LayoutManager & Optional<$CurrentLocation>;
/**
...
export declare class LocationContainerControlParams extends BaseControlParams {
    ...
    customLayoutLoader?: (sender: LocationContainerControl) => JQueryDeferred<GenModels.LayoutViewModel>;
...
/** @deprecated Renamed to LocationContainer */
export declare type LayoutPosition = LayoutContainer<any>;
/** @deprecated Renamed to LocationContainer */
export declare const LayoutPosition: typeof LayoutContainer;
