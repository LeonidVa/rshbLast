import { AutoConsolidationImpl, AutoConsolidationState } from '@docsvision/webclient/Platform/AutoConsolidationImpl';
...
export declare class AutoConsolidationParams extends BaseControlParams {
    ...
    services?: $Layout & $RequestManager & $SiteUrl & $WebServices & $CardInfo & $ApplicationSettings & $EditOperationStore;
}
export declare class AutoConsolidation extends BaseControl<AutoConsolidationParams, AutoConsolidationState> {
