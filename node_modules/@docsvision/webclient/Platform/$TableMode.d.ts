...
export declare type $TableMode = {
    tableMode: ITableModeService;
};
export declare const $TableMode: 
import("C:/dev/WebClient/Bin/TypeScriptDefinitions/System/Core/Utils/Common/GetFieldName").FieldSpec<$TableMode, ITableModeService>;
