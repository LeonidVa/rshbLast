...
import { $CardId, $RowInfo } from '@docsvision/webclient/System/LayoutServices';
...
export declare class TableParams extends PanelParams {
    ...
    services?: $LayoutCardController & $LayoutRowController & $Layout & $CardId & Optional<$RowInfo> & $LayoutManager;
}
/**
...
export declare class Table extends Panel<TableParams, TableState> {
    ...
    /** @internal */
    protected saveTable(options?: SaveCardOptions): JQueryDeferred<any>;
    ...
    /** @internal */
    protected onCardSaving(sender: any, args: ICancelableEventArgs<GenModels.SaveControlDataModel | GenModels.SaveRowControlDataModel>): void;
    /** @internal */
