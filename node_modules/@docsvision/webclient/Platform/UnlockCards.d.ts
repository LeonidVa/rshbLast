...
export interface UnlockCardsState extends UnlockCardsParams, BaseControlState {
}
/**
 * Элемент управления для отборажения имени и должности пользователя
 */
export declare class UnlockCards extends BaseControl<UnlockCardsParams, UnlockCardsState> {
    /** @internal */
