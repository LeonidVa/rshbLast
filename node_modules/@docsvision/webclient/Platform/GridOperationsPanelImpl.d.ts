...
export interface GridOperationsPanelState extends GridOperationsPanelParams, BaseControlState {
 ...
 */
export declare class GridOperationsPanelImpl extends BaseControlImpl<GridOperationsPanelParams, GridOperationsPanelState> {
