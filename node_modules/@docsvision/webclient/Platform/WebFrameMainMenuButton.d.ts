...
export interface WebFrameMainMenuButtonState extends WebFrameMainMenuButtonParams, BaseControlState {
}
/**
 * Класс элемента управления WebFrameMainMenuButton.
 */
export declare class WebFrameMainMenuButton extends BaseControl<WebFrameMainMenuButtonParams, WebFrameMainMenuButtonState> {
    /** @notest @internal */
